...
public class CollectionViewPushRequester extends io.intino.alexandria.ui.displays.requesters.TemplatePushRequester {

	public void execute(UIClient client, UIMessage message) {
		CollectionView display = display(client, message);
