...
public class PostSaveUserResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostSaveUserResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveUserAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveUserAction fill(io.intino.goros.unit.box.actions.PostSaveUserAction action) {
		action.box = this.box;
