...
public class PostSaveUserResource implements Resource {
	...
	public PostSaveUserResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostSaveUserAction()).execute());
	}

	private org.siani.goros.box.actions.PostSaveUserAction fill(org.siani.goros.box.actions.PostSaveUserAction action) {
		action.box = this.box;
