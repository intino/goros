...
public class PostGetSourceParentTermResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetSourceParentTermResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetSourceParentTermAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetSourceParentTermAction fill(io.intino.goros.unit.box.actions.PostGetSourceParentTermAction action) {
		action.box = this.box;
