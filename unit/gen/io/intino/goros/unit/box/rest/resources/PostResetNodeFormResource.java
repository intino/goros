...
public class PostResetNodeFormResource implements Resource {
	...
	public PostResetNodeFormResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostResetNodeFormAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostResetNodeFormAction fill(io.intino.goros.unit.box.actions.PostResetNodeFormAction action) {
		action.box = this.box;
