...
public class PostGetTaskFlagsResource implements Resource {
	...
	public PostGetTaskFlagsResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostGetTaskFlagsAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetTaskFlagsAction fill(org.siani.goros.box.actions.PostGetTaskFlagsAction action) {
		action.box = this.box;
