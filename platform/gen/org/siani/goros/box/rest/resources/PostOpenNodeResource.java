...
public class PostOpenNodeResource implements Resource {
	...
	public PostOpenNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostOpenNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostOpenNodeAction fill(org.siani.goros.box.actions.PostOpenNodeAction action) {
		action.box = this.box;
