...
public class PostGetNodeTasksResource implements Resource {
	...
	public PostGetNodeTasksResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeTasksAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeTasksAction fill(org.siani.goros.box.actions.PostGetNodeTasksAction action) {
		action.box = this.box;
