...
public class PostResumeTaskResource implements Resource {
	...
	public PostResumeTaskResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostResumeTaskAction()).execute());
	}

	private org.siani.goros.box.actions.PostResumeTaskAction fill(org.siani.goros.box.actions.PostResumeTaskAction action) {
		action.box = this.box;
