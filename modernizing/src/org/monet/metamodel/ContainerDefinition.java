...
public class ContainerDefinition extends ContainerDefinitionBase implements IsInitiable {
	...
	public void init() {
		ArrayList<ViewProperty> viewsToRemove = new ArrayList<ViewProperty>();
		ArrayList<ViewProperty> viewsToAdd = new ArrayList<ViewProperty>();
	...
	public void deleteTabViews(ArrayList<ViewProperty> viewsToRemove) {
		for (ViewProperty view : viewsToRemove) {
	...
	public void addTabViews(ArrayList<ViewProperty> viewsToAdd) {
		for (ViewProperty view : viewsToAdd) {
