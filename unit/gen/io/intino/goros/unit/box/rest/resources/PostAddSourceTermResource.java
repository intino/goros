...
public class PostAddSourceTermResource implements Resource {
	...
	public PostAddSourceTermResource(UnitBox box, SparkManager manager) {
		this.box = box;
	...
	private io.intino.goros.unit.box.actions.PostAddSourceTermAction fill(io.intino.goros.unit.box.actions.PostAddSourceTermAction action) {
		action.box = this.box;
