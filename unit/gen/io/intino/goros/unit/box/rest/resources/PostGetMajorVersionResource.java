...
public class PostGetMajorVersionResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetMajorVersionResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetMajorVersionAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetMajorVersionAction fill(io.intino.goros.unit.box.actions.PostGetMajorVersionAction action) {
		action.box = this.box;
