...
public class PostDeleteTaskShortcutResource implements Resource {
	...
	public PostDeleteTaskShortcutResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostDeleteTaskShortcutAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostDeleteTaskShortcutAction fill(io.intino.goros.unit.box.actions.PostDeleteTaskShortcutAction action) {
		action.box = this.box;
