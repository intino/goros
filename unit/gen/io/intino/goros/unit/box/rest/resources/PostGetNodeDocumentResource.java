...
public class PostGetNodeDocumentResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeDocumentResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeDocumentAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeDocumentAction fill(io.intino.goros.unit.box.actions.PostGetNodeDocumentAction action) {
		action.box = this.box;
