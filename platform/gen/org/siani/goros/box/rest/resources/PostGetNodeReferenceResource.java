...
public class PostGetNodeReferenceResource implements Resource {
	...
	public PostGetNodeReferenceResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeReferenceAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeReferenceAction fill(org.siani.goros.box.actions.PostGetNodeReferenceAction action) {
		action.box = this.box;
