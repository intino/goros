...
public class PostShowApiResource implements Resource {
	...
	public PostShowApiResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostShowApiAction()).execute());
	}

	private org.siani.goros.box.actions.PostShowApiAction fill(org.siani.goros.box.actions.PostShowApiAction action) {
		action.box = this.box;
