...
import io.intino.goros.box.ui.displays.templates.AbstractNodeDocumentTemplate;
import io.intino.goros.util.NodeHelper;

import java.io.ByteArrayInputStream;
import java.io.InputStream;

public class NodeDocumentTemplate extends AbstractNodeDocumentTemplate<GorosBox> {
    private Node node;
    private boolean readonly;
    private Resource newDocumentResource = null;

    public NodeDocumentTemplate(GorosBox box) {
        super(box);
    }
