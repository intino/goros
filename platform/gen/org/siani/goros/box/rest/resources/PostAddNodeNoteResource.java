...
public class PostAddNodeNoteResource implements Resource {
	...
	public PostAddNodeNoteResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostAddNodeNoteAction()).execute());
	}

	private org.siani.goros.box.actions.PostAddNodeNoteAction fill(org.siani.goros.box.actions.PostAddNodeNoteAction action) {
		action.box = this.box;
