...
public class PostGetTaskFlagsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetTaskFlagsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetTaskFlagsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetTaskFlagsAction fill(io.intino.goros.unit.box.actions.PostGetTaskFlagsAction action) {
		action.box = this.box;
