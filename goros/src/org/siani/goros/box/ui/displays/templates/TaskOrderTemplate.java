...
import org.siani.goros.box.ui.datasources.FormDatasource;
...
public class TaskOrderTemplate extends AbstractTaskOrderTemplate<GorosBox> {
    private Node node;
    ...
    public TaskOrderTemplate(GorosBox box) {
        super(box);
    }
