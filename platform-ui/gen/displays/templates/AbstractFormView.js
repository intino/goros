	...
	render() {
		...
		return(
			<UiBlock layout="vertical" style={{...this.props.style,...display}}>
				<UiMultiple context={this._context.bind(this)} owner={this._owner.bind(this)} id="gJY" multiple={{instances:"formView0",arrangement:"Vertical",noItemsMessage:"",spacing:0}}>
				</UiMultiple>
			</UiBlock>
		);
	}
