...
public class PostRegisterResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostRegisterResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostRegisterAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostRegisterAction fill(io.intino.goros.unit.box.actions.PostRegisterAction action) {
		action.box = this.box;
