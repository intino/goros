...
import io.intino.goros.box.ui.datasources.FederationUnitFeederListDatasource;
import io.intino.goros.box.ui.datasources.FederationUnitServiceListDatasource;
import io.intino.goros.box.ui.datasources.UserListDatasource;
import io.intino.goros.box.ui.datasources.model.role.RoleTypeGrouping;
import io.intino.goros.box.ui.displays.rows.AddRoleFeederTableRow;
import io.intino.goros.box.ui.displays.rows.AddRoleServiceTableRow;
import io.intino.goros.box.ui.displays.rows.AddRoleUserTableRow;
...
public class RolesToolbarTemplate extends AbstractRolesToolbarTemplate<GorosBox> {
    ...
    public RolesToolbarTemplate(GorosBox box) {
        super(box);
    }
