...
public class PostDeleteTaskFlagResource implements Resource {
	...
	public PostDeleteTaskFlagResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostDeleteTaskFlagAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostDeleteTaskFlagAction fill(io.intino.goros.unit.box.actions.PostDeleteTaskFlagAction action) {
		action.box = this.box;
