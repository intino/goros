...
public class PostExistsNodeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostExistsNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostExistsNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostExistsNodeAction fill(io.intino.goros.unit.box.actions.PostExistsNodeAction action) {
		action.box = this.box;
