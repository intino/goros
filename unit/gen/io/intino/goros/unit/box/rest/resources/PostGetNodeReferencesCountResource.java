...
public class PostGetNodeReferencesCountResource implements Resource {
	...
	public PostGetNodeReferencesCountResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeReferencesCountAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeReferencesCountAction fill(io.intino.goros.unit.box.actions.PostGetNodeReferencesCountAction action) {
		action.box = this.box;
