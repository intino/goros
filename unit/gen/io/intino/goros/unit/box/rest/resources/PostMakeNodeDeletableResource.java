...
public class PostMakeNodeDeletableResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostMakeNodeDeletableResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostMakeNodeDeletableAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostMakeNodeDeletableAction fill(io.intino.goros.unit.box.actions.PostMakeNodeDeletableAction action) {
		action.box = this.box;
