...
public class PostGetUserNodeResource implements Resource {
	...
	public PostGetUserNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetUserNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetUserNodeAction fill(org.siani.goros.box.actions.PostGetUserNodeAction action) {
		action.box = this.box;
