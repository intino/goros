...
public class LinksInTableLabelItem extends io.intino.alexandria.ui.displays.components.Item<ItemNotifier, org.monet.space.kernel.model.Node, UnitBox> {
	public Label label;

    public LinksInTableLabelItem(UnitBox box) {
        super(box);
        id("a1456117662");
    }
	...
	public void init() {
		super.init();
		if (label == null) label = register(new Label(box()).<Label>id("a_1299068141").owner(LinksInTableLabelItem.this));
	}
