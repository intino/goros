...
public class GetDownloadDocumentResource implements Resource {

	private DocumentsBox box;
	private SparkManager<SparkPushService> manager;

	public GetDownloadDocumentResource(DocumentsBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.documents.box.actions.GetDownloadDocumentAction()).execute());
	}
