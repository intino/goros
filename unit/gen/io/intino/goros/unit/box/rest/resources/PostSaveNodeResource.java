...
public class PostSaveNodeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostSaveNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveNodeAction fill(io.intino.goros.unit.box.actions.PostSaveNodeAction action) {
		action.box = this.box;
