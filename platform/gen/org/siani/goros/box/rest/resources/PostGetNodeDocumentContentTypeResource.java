...
public class PostGetNodeDocumentContentTypeResource implements Resource {
	...
	public PostGetNodeDocumentContentTypeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeDocumentContentTypeAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeDocumentContentTypeAction fill(org.siani.goros.box.actions.PostGetNodeDocumentContentTypeAction action) {
		action.box = this.box;
