...
public class PostGetNodeAncestorsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeAncestorsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeAncestorsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeAncestorsAction fill(io.intino.goros.unit.box.actions.PostGetNodeAncestorsAction action) {
		action.box = this.box;
