...
public class PostAddSourceTermResource implements Resource {
	...
	public PostAddSourceTermResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostAddSourceTermAction()).execute());
	}

	private org.siani.goros.box.actions.PostAddSourceTermAction fill(org.siani.goros.box.actions.PostAddSourceTermAction action) {
		action.box = this.box;
		...
		action.source = manager.fromQuery("source", String.class);
		action.label = manager.fromQuery("label", String.class);
		action.tags = manager.fromQuery("tags", String.class);
		return action;
	}
