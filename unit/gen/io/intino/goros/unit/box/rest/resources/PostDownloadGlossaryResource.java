...
public class PostDownloadGlossaryResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostDownloadGlossaryResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostDownloadGlossaryAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostDownloadGlossaryAction fill(io.intino.goros.unit.box.actions.PostDownloadGlossaryAction action) {
		action.box = this.box;
