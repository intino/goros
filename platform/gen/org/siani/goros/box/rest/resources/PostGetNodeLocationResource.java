...
public class PostGetNodeLocationResource implements Resource {
	...
	public PostGetNodeLocationResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeLocationAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeLocationAction fill(org.siani.goros.box.actions.PostGetNodeLocationAction action) {
		action.box = this.box;
