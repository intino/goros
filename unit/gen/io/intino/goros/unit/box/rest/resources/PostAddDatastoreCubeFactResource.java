...
public class PostAddDatastoreCubeFactResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostAddDatastoreCubeFactResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostAddDatastoreCubeFactAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostAddDatastoreCubeFactAction fill(io.intino.goros.unit.box.actions.PostAddDatastoreCubeFactAction action) {
		action.box = this.box;
