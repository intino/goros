...
public class PostGetTaskShortcutsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetTaskShortcutsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetTaskShortcutsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetTaskShortcutsAction fill(io.intino.goros.unit.box.actions.PostGetTaskShortcutsAction action) {
		action.box = this.box;
