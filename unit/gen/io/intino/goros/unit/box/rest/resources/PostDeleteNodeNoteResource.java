...
public class PostDeleteNodeNoteResource implements Resource {
	...
	public PostDeleteNodeNoteResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostDeleteNodeNoteAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostDeleteNodeNoteAction fill(io.intino.goros.unit.box.actions.PostDeleteNodeNoteAction action) {
		action.box = this.box;
