...
public class XlsTaskListTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(allTypes("attribute")).output(literal("<Cell ss:StyleID=\"s64\"><Data ss:Type=\"String\">")).output(placeholder("value")).output(literal("</Data></Cell>")));
		return rules;
	}
