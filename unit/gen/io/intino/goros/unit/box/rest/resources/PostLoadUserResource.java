...
public class PostLoadUserResource implements Resource {
	...
	public PostLoadUserResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadUserAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadUserAction fill(io.intino.goros.unit.box.actions.PostLoadUserAction action) {
		action.box = this.box;
