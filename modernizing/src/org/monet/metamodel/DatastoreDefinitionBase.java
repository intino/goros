...
}}protected LinkedHashMap<String, DimensionProperty> _dimensionPropertyMap = new LinkedHashMap<String, DimensionProperty>();public void addDimension(DimensionProperty value) {String key = value.getName() != null ? value.getName() : value.getCode();DimensionProperty current = _dimensionPropertyMap.get(key);if (current != null) {if (current.getClass().isAssignableFrom(value.getClass())) {try {DimensionProperty instance = value.getClass().newInstance();instance.copy(current);instance.setCode(value.getCode());instance.setName(value.getName());instance.merge(value);_dimensionPropertyMap.put(key, instance);}catch (Exception exception) {}}else current.merge(value);} else {_dimensionPropertyMap.put(key, value);} }public Map<String,DimensionProperty> getDimensionMap() { return _dimensionPropertyMap; }public Collection<DimensionProperty> getDimensionList() { return _dimensionPropertyMap.values(); }public static class CubeProperty extends ReferenceableProperty {protected Object _label;public Object getLabel() { return _label; }public void setLabel(Object value) { _label = value; }public enum ResolutionEnumeration { YEARS,MONTHS,DAYS,HOURS,MINUTES,SECONDS }protected ResolutionEnumeration _resolution;public ResolutionEnumeration getResolution() { return _resolution; }public void setResolution(ResolutionEnumeration value) { _resolution = value; }protected ArrayList<org.monet.metamodel.internal.Ref> _use = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getUse() { return _use; }public void setUse(ArrayList<org.monet.metamodel.internal.Ref> value) { _use = value; }public static class MetricProperty extends ReferenceableProperty {protected Object _label;public Object getLabel() { return _label; }public void setLabel(Object value) { _label = value; }protected org.monet.metamodel.internal.Ref _scale;public org.monet.metamodel.internal.Ref getScale() { return _scale; }public void setScale(org.monet.metamodel.internal.Ref value) { _scale = value; }protected void copy(MetricProperty instance) {this._label = instance._label;
...
}}protected LinkedHashMap<String, MetricProperty> _metricPropertyMap = new LinkedHashMap<String, MetricProperty>();public void addMetric(MetricProperty value) {String key = value.getName() != null ? value.getName() : value.getCode();MetricProperty current = _metricPropertyMap.get(key);if (current != null) {if (current.getClass().isAssignableFrom(value.getClass())) {try {MetricProperty instance = value.getClass().newInstance();instance.copy(current);instance.setCode(value.getCode());instance.setName(value.getName());instance.merge(value);_metricPropertyMap.put(key, instance);}catch (Exception exception) {}}else current.merge(value);} else {_metricPropertyMap.put(key, value);} }public Map<String,MetricProperty> getMetricMap() { return _metricPropertyMap; }public Collection<MetricProperty> getMetricList() { return _metricPropertyMap.values(); }protected void copy(CubeProperty instance) {this._label = instance._label;
