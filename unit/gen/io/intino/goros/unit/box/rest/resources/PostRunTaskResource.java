...
public class PostRunTaskResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostRunTaskResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostRunTaskAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostRunTaskAction fill(io.intino.goros.unit.box.actions.PostRunTaskAction action) {
		action.box = this.box;
