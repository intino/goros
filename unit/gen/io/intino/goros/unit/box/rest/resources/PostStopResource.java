...
public class PostStopResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostStopResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostStopAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostStopAction fill(io.intino.goros.unit.box.actions.PostStopAction action) {
		action.box = this.box;
