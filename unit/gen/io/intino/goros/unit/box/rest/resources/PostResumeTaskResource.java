...
public class PostResumeTaskResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostResumeTaskResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostResumeTaskAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostResumeTaskAction fill(io.intino.goros.unit.box.actions.PostResumeTaskAction action) {
		action.box = this.box;
