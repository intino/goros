...
public class PostGetUserLinkedToNodeResource implements Resource {
	...
	public PostGetUserLinkedToNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetUserLinkedToNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetUserLinkedToNodeAction fill(org.siani.goros.box.actions.PostGetUserLinkedToNodeAction action) {
		action.box = this.box;
