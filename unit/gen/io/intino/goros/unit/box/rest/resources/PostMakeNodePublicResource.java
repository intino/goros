...
public class PostMakeNodePublicResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostMakeNodePublicResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostMakeNodePublicAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostMakeNodePublicAction fill(io.intino.goros.unit.box.actions.PostMakeNodePublicAction action) {
		action.box = this.box;
