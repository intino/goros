...
public class PostGetTaskFactsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetTaskFactsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetTaskFactsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetTaskFactsAction fill(io.intino.goros.unit.box.actions.PostGetTaskFactsAction action) {
		action.box = this.box;
