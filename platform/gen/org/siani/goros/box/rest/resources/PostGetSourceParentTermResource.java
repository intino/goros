...
public class PostGetSourceParentTermResource implements Resource {
	...
	public PostGetSourceParentTermResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetSourceParentTermAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetSourceParentTermAction fill(org.siani.goros.box.actions.PostGetSourceParentTermAction action) {
		action.box = this.box;
