...
public class PostRemoveTaskResource implements Resource {
	...
	public PostRemoveTaskResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostRemoveTaskAction()).execute());
	}

	private org.siani.goros.box.actions.PostRemoveTaskAction fill(org.siani.goros.box.actions.PostRemoveTaskAction action) {
		action.box = this.box;
