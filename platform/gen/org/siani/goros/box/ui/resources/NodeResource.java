...
import org.siani.goros.box.ui.pages.NodePage;
...
public class NodeResource extends io.intino.alexandria.ui.spark.resources.Resource {
	private final GorosBox box;

	public NodeResource(GorosBox box, io.intino.alexandria.ui.spark.UISparkManager manager, DisplayNotifierProvider notifierProvider) {
	...
	private void render() {
		...
		page.session.whenLogin(new Function<String, String>() {
			...
			public String apply(String baseUrl) {
				return NodeResource.this.authenticate(baseUrl);
			}
		});
