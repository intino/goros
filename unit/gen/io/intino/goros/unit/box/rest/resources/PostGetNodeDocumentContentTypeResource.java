...
public class PostGetNodeDocumentContentTypeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeDocumentContentTypeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeDocumentContentTypeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeDocumentContentTypeAction fill(io.intino.goros.unit.box.actions.PostGetNodeDocumentContentTypeAction action) {
		action.box = this.box;
