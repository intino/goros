...
public class PostAddNodeNoteResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostAddNodeNoteResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostAddNodeNoteAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostAddNodeNoteAction fill(io.intino.goros.unit.box.actions.PostAddNodeNoteAction action) {
		action.box = this.box;
