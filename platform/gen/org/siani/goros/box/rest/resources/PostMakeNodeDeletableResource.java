...
public class PostMakeNodeDeletableResource implements Resource {
	...
	public PostMakeNodeDeletableResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostMakeNodeDeletableAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodeDeletableAction fill(org.siani.goros.box.actions.PostMakeNodeDeletableAction action) {
		action.box = this.box;
