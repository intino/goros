...
public class PostAddTaskFlagResource implements Resource {
	...
	public PostAddTaskFlagResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostAddTaskFlagAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostAddTaskFlagAction fill(io.intino.goros.unit.box.actions.PostAddTaskFlagAction action) {
		action.box = this.box;
