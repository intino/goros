...
public class PostSaveNodeDocumentResource implements Resource {
	...
	public PostSaveNodeDocumentResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveNodeDocumentAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveNodeDocumentAction fill(io.intino.goros.unit.box.actions.PostSaveNodeDocumentAction action) {
		action.box = this.box;
