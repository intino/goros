...
public class PostMakeNodeEditableResource implements Resource {
	...
	public PostMakeNodeEditableResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostMakeNodeEditableAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodeEditableAction fill(org.siani.goros.box.actions.PostMakeNodeEditableAction action) {
		action.box = this.box;
