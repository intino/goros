...
public class PostRunTaskResource implements Resource {
	...
	public PostRunTaskResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostRunTaskAction()).execute());
	}

	private org.siani.goros.box.actions.PostRunTaskAction fill(org.siani.goros.box.actions.PostRunTaskAction action) {
		action.box = this.box;
