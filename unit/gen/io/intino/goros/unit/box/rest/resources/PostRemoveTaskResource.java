...
public class PostRemoveTaskResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostRemoveTaskResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostRemoveTaskAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostRemoveTaskAction fill(io.intino.goros.unit.box.actions.PostRemoveTaskAction action) {
		action.box = this.box;
