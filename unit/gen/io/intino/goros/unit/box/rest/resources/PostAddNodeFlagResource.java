...
public class PostAddNodeFlagResource implements Resource {
	...
	public PostAddNodeFlagResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostAddNodeFlagAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostAddNodeFlagAction fill(io.intino.goros.unit.box.actions.PostAddNodeFlagAction action) {
		action.box = this.box;
