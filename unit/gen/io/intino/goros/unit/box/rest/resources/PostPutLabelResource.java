...
public class PostPutLabelResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostPutLabelResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostPutLabelAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostPutLabelAction fill(io.intino.goros.unit.box.actions.PostPutLabelAction action) {
		action.box = this.box;
