...
public class PostLoadNewAvailableTasksResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadNewAvailableTasksResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadNewAvailableTasksAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadNewAvailableTasksAction fill(io.intino.goros.unit.box.actions.PostLoadNewAvailableTasksAction action) {
		action.box = this.box;
