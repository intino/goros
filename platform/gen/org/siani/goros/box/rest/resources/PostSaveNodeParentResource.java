...
public class PostSaveNodeParentResource implements Resource {
	...
	public PostSaveNodeParentResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostSaveNodeParentAction()).execute());
	}

	private org.siani.goros.box.actions.PostSaveNodeParentAction fill(org.siani.goros.box.actions.PostSaveNodeParentAction action) {
		action.box = this.box;
