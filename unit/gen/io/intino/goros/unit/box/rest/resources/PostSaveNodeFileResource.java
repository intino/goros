...
public class PostSaveNodeFileResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostSaveNodeFileResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveNodeFileAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveNodeFileAction fill(io.intino.goros.unit.box.actions.PostSaveNodeFileAction action) {
		action.box = this.box;
