...
import org.siani.goros.box.ui.pages.TaskPage;
...
public class TaskResource extends io.intino.alexandria.ui.spark.resources.Resource {
	private final GorosBox box;

	public TaskResource(GorosBox box, io.intino.alexandria.ui.spark.UISparkManager manager, DisplayNotifierProvider notifierProvider) {
	...
	private void render() {
		...
		page.session.whenLogin(new Function<String, String>() {
			...
			public String apply(String baseUrl) {
				return TaskResource.this.authenticate(baseUrl);
			}
		});
