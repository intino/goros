...
public class PostRecoverNodeResource implements Resource {
	...
	public PostRecoverNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostRecoverNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostRecoverNodeAction fill(io.intino.goros.unit.box.actions.PostRecoverNodeAction action) {
		action.box = this.box;
