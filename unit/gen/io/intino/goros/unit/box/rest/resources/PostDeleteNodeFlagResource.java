...
public class PostDeleteNodeFlagResource implements Resource {
	...
	public PostDeleteNodeFlagResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostDeleteNodeFlagAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostDeleteNodeFlagAction fill(io.intino.goros.unit.box.actions.PostDeleteNodeFlagAction action) {
		action.box = this.box;
