...
public class PostGetNodeLocationResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeLocationResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeLocationAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeLocationAction fill(io.intino.goros.unit.box.actions.PostGetNodeLocationAction action) {
		action.box = this.box;
