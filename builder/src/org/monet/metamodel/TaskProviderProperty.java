...
}}protected InternalProperty _internalProperty;public InternalProperty getInternal() { return _internalProperty; }public void setInternal(InternalProperty value) { if(_internalProperty!=null) _internalProperty.merge(value); else {_internalProperty = value;} }public static class ExternalProperty  {public static class RequestProperty extends TaskRequestProperty {protected void copy(RequestProperty instance) {this._code = instance._code;
this._name = instance._name;
}protected void merge(RequestProperty child) {super.merge(child);}}protected LinkedHashMap<String, RequestProperty> _requestPropertyMap = new LinkedHashMap<String, RequestProperty>();public void addRequest(RequestProperty value) {RequestProperty current = _requestPropertyMap.get(value.getName());if (current != null) {if (current.getClass().isAssignableFrom(value.getClass())) {try {RequestProperty instance = value.getClass().newInstance();instance.copy(current);instance.setName(value.getName());instance.merge(value);_requestPropertyMap.put(value.getName(), instance);}catch (Exception exception) {}}else current.merge(value);} else {_requestPropertyMap.put(value.getName(), value);} }public Map<String,RequestProperty> getRequestMap() { return _requestPropertyMap; }public Collection<RequestProperty> getRequestList() { return _requestPropertyMap.values(); }public static class ResponseProperty extends TaskResponseProperty {protected void copy(ResponseProperty instance) {this._code = instance._code;
this._name = instance._name;
this._unlock = instance._unlock;
