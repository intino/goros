...
}}protected ServiceDefinition.CustomerProperty _customerProperty;public ServiceDefinition.CustomerProperty getCustomer() { return _customerProperty; }public void setCustomer(ServiceDefinition.CustomerProperty value) { if(_customerProperty!=null) _customerProperty.merge(value); else {_customerProperty = value;} }public static class ServicePlacePropertyBase extends PlaceProperty {protected void copy(ServicePlacePropertyBase instance) {this._code = instance._code;
this._name = instance._name;
