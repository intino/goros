...
public class PostGetTaskFactsResource implements Resource {
	...
	public PostGetTaskFactsResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetTaskFactsAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetTaskFactsAction fill(org.siani.goros.box.actions.PostGetTaskFactsAction action) {
		action.box = this.box;
