...
public class PostGetNodeAncestorsResource implements Resource {
	...
	public PostGetNodeAncestorsResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeAncestorsAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeAncestorsAction fill(org.siani.goros.box.actions.PostGetNodeAncestorsAction action) {
		action.box = this.box;
