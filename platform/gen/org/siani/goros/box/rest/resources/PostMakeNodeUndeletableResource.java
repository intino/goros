...
public class PostMakeNodeUndeletableResource implements Resource {
	...
	public PostMakeNodeUndeletableResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostMakeNodeUndeletableAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodeUndeletableAction fill(org.siani.goros.box.actions.PostMakeNodeUndeletableAction action) {
		action.box = this.box;
