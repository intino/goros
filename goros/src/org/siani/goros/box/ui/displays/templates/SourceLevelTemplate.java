...
import org.siani.goros.box.ui.datasources.SourceDatasource;
import org.siani.goros.box.ui.displays.items.SourceLevelListItem;
import org.siani.goros.util.SourceHelper;

import java.util.List;
import java.util.function.BiConsumer;

public class SourceLevelTemplate extends AbstractSourceLevelTemplate<GorosBox> {
    private Source<SourceDefinition> source;
    private Term term;
    private BiConsumer<Term, Integer> selectListener;
    private int level = -1;

    public SourceLevelTemplate(GorosBox box) {
        super(box);
    }
