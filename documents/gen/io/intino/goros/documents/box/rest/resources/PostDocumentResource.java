...
public class PostDocumentResource implements Resource {
	...
	public PostDocumentResource(DocumentsBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.documents.box.actions.PostDocumentAction()).execute());
	}

	private io.intino.goros.documents.box.actions.PostDocumentAction fill(io.intino.goros.documents.box.actions.PostDocumentAction action) {
		action.box = this.box;
