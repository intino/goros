...
public class PostMakeNodePublicResource implements Resource {
	...
	public PostMakeNodePublicResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostMakeNodePublicAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodePublicAction fill(org.siani.goros.box.actions.PostMakeNodePublicAction action) {
		action.box = this.box;
