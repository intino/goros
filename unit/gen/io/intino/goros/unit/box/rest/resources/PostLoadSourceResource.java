...
public class PostLoadSourceResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadSourceResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadSourceAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadSourceAction fill(io.intino.goros.unit.box.actions.PostLoadSourceAction action) {
		action.box = this.box;
