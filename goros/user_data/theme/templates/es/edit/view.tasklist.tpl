...
<div id="::id::tasklistviewer_::type::_options" style="display:none;">
  ...
  Options.GroupByList.Items["background"].Options[0] = {Code: '0', Label: 'Solo tareas de sistema'};
  Options.GroupByList.Items["background"].Options[1] = {Code: '1', Label: 'Todas las tareas'};
  ::groupByListTypes::
  ::groupByListOwners::
  ::groupByListSenders::
</div>
