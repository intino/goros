...
public class PostGetUserNodeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetUserNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetUserNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetUserNodeAction fill(io.intino.goros.unit.box.actions.PostGetUserNodeAction action) {
		action.box = this.box;
