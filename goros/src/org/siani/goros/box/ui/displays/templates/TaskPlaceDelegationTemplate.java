...
import org.siani.goros.box.ui.DisplayProvider;
...
public class TaskPlaceDelegationTemplate extends AbstractTaskPlaceDelegationTemplate<GorosBox> {
    private Task task;
    private DelegationActionProperty property;
    private DisplayProvider displayProvider;

    public TaskPlaceDelegationTemplate(GorosBox box) {
        super(box);
    }
