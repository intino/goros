...
public class PostConsolidateNodeResource implements Resource {
	...
	public PostConsolidateNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostConsolidateNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostConsolidateNodeAction fill(io.intino.goros.unit.box.actions.PostConsolidateNodeAction action) {
		action.box = this.box;
