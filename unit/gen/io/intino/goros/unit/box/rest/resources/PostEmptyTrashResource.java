...
public class PostEmptyTrashResource implements Resource {
	...
	public PostEmptyTrashResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostEmptyTrashAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostEmptyTrashAction fill(io.intino.goros.unit.box.actions.PostEmptyTrashAction action) {
		action.box = this.box;
