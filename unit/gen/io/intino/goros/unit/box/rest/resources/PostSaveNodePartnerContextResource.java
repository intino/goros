...
public class PostSaveNodePartnerContextResource implements Resource {
	...
	public PostSaveNodePartnerContextResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveNodePartnerContextAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveNodePartnerContextAction fill(io.intino.goros.unit.box.actions.PostSaveNodePartnerContextAction action) {
		action.box = this.box;
