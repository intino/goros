...
public class PostLoadFinishedTasksToDeleteResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadFinishedTasksToDeleteResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadFinishedTasksToDeleteAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadFinishedTasksToDeleteAction fill(io.intino.goros.unit.box.actions.PostLoadFinishedTasksToDeleteAction action) {
		action.box = this.box;
