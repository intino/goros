...
public class PostUnregisterResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostUnregisterResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostUnregisterAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostUnregisterAction fill(io.intino.goros.unit.box.actions.PostUnregisterAction action) {
		action.box = this.box;
