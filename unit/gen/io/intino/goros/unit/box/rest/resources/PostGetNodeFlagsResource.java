...
public class PostGetNodeFlagsResource implements Resource {
	...
	public PostGetNodeFlagsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeFlagsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeFlagsAction fill(io.intino.goros.unit.box.actions.PostGetNodeFlagsAction action) {
		action.box = this.box;
