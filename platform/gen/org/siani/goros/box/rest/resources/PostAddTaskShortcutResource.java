...
public class PostAddTaskShortcutResource implements Resource {
	...
	public PostAddTaskShortcutResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostAddTaskShortcutAction()).execute());
	}

	private org.siani.goros.box.actions.PostAddTaskShortcutAction fill(org.siani.goros.box.actions.PostAddTaskShortcutAction action) {
		action.box = this.box;
