...
public class PostGetNodeFileResource implements Resource {
	...
	public PostGetNodeFileResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeFileAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeFileAction fill(io.intino.goros.unit.box.actions.PostGetNodeFileAction action) {
		action.box = this.box;
