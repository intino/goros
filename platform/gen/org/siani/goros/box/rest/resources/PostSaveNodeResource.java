...
public class PostSaveNodeResource implements Resource {
	...
	public PostSaveNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostSaveNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostSaveNodeAction fill(org.siani.goros.box.actions.PostSaveNodeAction action) {
		action.box = this.box;
