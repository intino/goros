...
public class PostCreateNodeResource implements Resource {
	...
	public PostCreateNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostCreateNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostCreateNodeAction fill(io.intino.goros.unit.box.actions.PostCreateNodeAction action) {
		action.box = this.box;
