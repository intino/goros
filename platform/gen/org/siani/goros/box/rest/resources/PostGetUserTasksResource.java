...
public class PostGetUserTasksResource implements Resource {
	...
	public PostGetUserTasksResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetUserTasksAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetUserTasksAction fill(org.siani.goros.box.actions.PostGetUserTasksAction action) {
		action.box = this.box;
