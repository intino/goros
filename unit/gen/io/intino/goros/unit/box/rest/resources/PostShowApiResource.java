...
public class PostShowApiResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostShowApiResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostShowApiAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostShowApiAction fill(io.intino.goros.unit.box.actions.PostShowApiAction action) {
		action.box = this.box;
