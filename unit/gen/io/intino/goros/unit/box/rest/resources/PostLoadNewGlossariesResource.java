...
public class PostLoadNewGlossariesResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadNewGlossariesResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadNewGlossariesAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadNewGlossariesAction fill(io.intino.goros.unit.box.actions.PostLoadNewGlossariesAction action) {
		action.box = this.box;
