...
public class PostMakeNodeUneditableResource implements Resource {
	...
	public PostMakeNodeUneditableResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostMakeNodeUneditableAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodeUneditableAction fill(org.siani.goros.box.actions.PostMakeNodeUneditableAction action) {
		action.box = this.box;
