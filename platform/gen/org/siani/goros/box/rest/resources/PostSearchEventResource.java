...
public class PostSearchEventResource implements Resource {
	...
	public PostSearchEventResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostSearchEventAction()).execute());
	}

	private org.siani.goros.box.actions.PostSearchEventAction fill(org.siani.goros.box.actions.PostSearchEventAction action) {
		action.box = this.box;
