...
public class PostGetNodeSchemaResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeSchemaResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeSchemaAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeSchemaAction fill(io.intino.goros.unit.box.actions.PostGetNodeSchemaAction action) {
		action.box = this.box;
