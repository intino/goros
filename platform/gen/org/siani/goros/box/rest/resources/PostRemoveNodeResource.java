...
public class PostRemoveNodeResource implements Resource {
	...
	public PostRemoveNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostRemoveNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostRemoveNodeAction fill(org.siani.goros.box.actions.PostRemoveNodeAction action) {
		action.box = this.box;
