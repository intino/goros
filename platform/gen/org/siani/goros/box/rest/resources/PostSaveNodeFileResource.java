...
public class PostSaveNodeFileResource implements Resource {
	...
	public PostSaveNodeFileResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostSaveNodeFileAction()).execute());
	}

	private org.siani.goros.box.actions.PostSaveNodeFileAction fill(org.siani.goros.box.actions.PostSaveNodeFileAction action) {
		action.box = this.box;
