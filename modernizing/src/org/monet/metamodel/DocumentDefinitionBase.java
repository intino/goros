...
public  class DocumentDefinitionBase extends NodeDefinition {
	...
	public static class IsComponent  {protected void copy(IsComponent instance) {}protected void merge(IsComponent child) {}}protected IsComponent _isComponent;public boolean isComponent() { return (_isComponent != null); }public IsComponent getIsComponent() { return _isComponent; }public void setIsComponent(boolean value) { if(value) _isComponent = new IsComponent(); else {_isComponent = null;}}public static class SignaturesProperty  {public enum PositionEnumeration { BEGINNING,NEW_PAGE_AT_BEGINNING,END,NEW_PAGE_AT_END }protected PositionEnumeration _position;public PositionEnumeration getPosition() { return _position; }public void setPosition(PositionEnumeration value) { _position = value; }public static class SignatureProperty extends ReferenceableProperty {protected Object _label;public Object getLabel() { return _label; }public void setLabel(Object value) { _label = value; }protected ArrayList<org.monet.metamodel.internal.Ref> _for = new ArrayList<org.monet.metamodel.internal.Ref>();public ArrayList<org.monet.metamodel.internal.Ref> getFor() { return _for; }public void setFor(ArrayList<org.monet.metamodel.internal.Ref> value) { _for = value; }protected org.monet.metamodel.internal.Ref _after;public org.monet.metamodel.internal.Ref getAfter() { return _after; }public void setAfter(org.monet.metamodel.internal.Ref value) { _after = value; }protected Long _amount;public Long getAmount() { return _amount; }public void setAmount(Long value) { _amount = value; }protected void copy(SignatureProperty instance) {this._label = instance._label;
