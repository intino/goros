...
public class PostExportNodeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostExportNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostExportNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostExportNodeAction fill(io.intino.goros.unit.box.actions.PostExportNodeAction action) {
		action.box = this.box;
