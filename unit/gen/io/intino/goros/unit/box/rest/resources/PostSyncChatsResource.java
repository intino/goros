...
public class PostSyncChatsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostSyncChatsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSyncChatsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSyncChatsAction fill(io.intino.goros.unit.box.actions.PostSyncChatsAction action) {
		action.box = this.box;
