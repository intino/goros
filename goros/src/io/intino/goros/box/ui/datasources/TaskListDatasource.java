...
import io.intino.goros.box.ui.datasources.model.task.TaskNatureGrouping;
import io.intino.goros.box.ui.datasources.model.task.TaskUrgentGrouping;
...
public class TaskListDatasource extends PageDatasource<Task> {
    ...
    public TaskListDatasource(GorosBox box, UISession session, Inbox inbox) {
        this.box = box;
