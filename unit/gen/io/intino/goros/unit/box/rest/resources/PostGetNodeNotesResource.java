...
public class PostGetNodeNotesResource implements Resource {
	...
	public PostGetNodeNotesResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeNotesAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeNotesAction fill(io.intino.goros.unit.box.actions.PostGetNodeNotesAction action) {
		action.box = this.box;
