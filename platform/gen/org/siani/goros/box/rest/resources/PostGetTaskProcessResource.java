...
public class PostGetTaskProcessResource implements Resource {
	...
	public PostGetTaskProcessResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetTaskProcessAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetTaskProcessAction fill(org.siani.goros.box.actions.PostGetTaskProcessAction action) {
		action.box = this.box;
