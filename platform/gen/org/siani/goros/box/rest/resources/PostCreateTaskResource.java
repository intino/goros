...
public class PostCreateTaskResource implements Resource {
	...
	public PostCreateTaskResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostCreateTaskAction()).execute());
	}

	private org.siani.goros.box.actions.PostCreateTaskAction fill(org.siani.goros.box.actions.PostCreateTaskAction action) {
		action.box = this.box;
