...
import io.intino.goros.builders.renderers.templates.java.ActivityDefinitionTemplate;
...
public class ActivityRenderer extends DefinitionRenderer<ActivityDefinition> {
	...
	protected Template konosTemplate() {
		return new io.intino.goros.builders.renderers.templates.konos.ActivityDefinitionTemplate();
	}

	@Override
	protected Template javaTemplate() {
		return new io.intino.goros.builders.renderers.templates.java.ActivityDefinitionTemplate();
	}
