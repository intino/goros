...
public class PostGetTaskShortcutsResource implements Resource {
	...
	public PostGetTaskShortcutsResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetTaskShortcutsAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetTaskShortcutsAction fill(org.siani.goros.box.actions.PostGetTaskShortcutsAction action) {
		action.box = this.box;
