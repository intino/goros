...
public class PostLoadSourceResource implements Resource {
	...
	public PostLoadSourceResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostLoadSourceAction()).execute());
	}

	private org.siani.goros.box.actions.PostLoadSourceAction fill(org.siani.goros.box.actions.PostLoadSourceAction action) {
		action.box = this.box;
