...
public class PostMakeNodeUndeletableResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostMakeNodeUndeletableResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostMakeNodeUndeletableAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostMakeNodeUndeletableAction fill(io.intino.goros.unit.box.actions.PostMakeNodeUndeletableAction action) {
		action.box = this.box;
