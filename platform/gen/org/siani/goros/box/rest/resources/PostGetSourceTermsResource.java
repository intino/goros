...
public class PostGetSourceTermsResource implements Resource {
	...
	public PostGetSourceTermsResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetSourceTermsAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetSourceTermsAction fill(org.siani.goros.box.actions.PostGetSourceTermsAction action) {
		action.box = this.box;
