...
<div class="def configuration">
  ...
  configuration.toolbar.operationSet.push({type:"PRINT", label: "Download in PDF", parameters: {id:"::idNode::",format:"pdf"}});
  configuration.sidebar = new Object();
  configuration.sidebar.operationSet = new Array();
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Download in PDF", parameters: {id:"::idNode::",format:"pdf"}});
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Download in CSV", parameters: {id:"::idNode::",format:"csv"}});
  configuration.sidebar.operationSet.push({type:"PRINT", label: "Download in Excel", parameters: {id:"::idNode::",format:"xls"}});
