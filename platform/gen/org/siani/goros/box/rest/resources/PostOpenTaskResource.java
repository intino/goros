...
public class PostOpenTaskResource implements Resource {
	...
	public PostOpenTaskResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostOpenTaskAction()).execute());
	}

	private org.siani.goros.box.actions.PostOpenTaskAction fill(org.siani.goros.box.actions.PostOpenTaskAction action) {
		action.box = this.box;
