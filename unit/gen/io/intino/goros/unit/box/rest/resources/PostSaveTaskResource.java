...
public class PostSaveTaskResource implements Resource {
	...
	public PostSaveTaskResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveTaskAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveTaskAction fill(io.intino.goros.unit.box.actions.PostSaveTaskAction action) {
		action.box = this.box;
