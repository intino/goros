...
public class PostMakeNodeEditableResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostMakeNodeEditableResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostMakeNodeEditableAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostMakeNodeEditableAction fill(io.intino.goros.unit.box.actions.PostMakeNodeEditableAction action) {
		action.box = this.box;
