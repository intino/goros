...
public class PostLoadNewDefinitionsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadNewDefinitionsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadNewDefinitionsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadNewDefinitionsAction fill(io.intino.goros.unit.box.actions.PostLoadNewDefinitionsAction action) {
		action.box = this.box;
