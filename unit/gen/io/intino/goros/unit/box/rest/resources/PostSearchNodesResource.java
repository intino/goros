...
public class PostSearchNodesResource implements Resource {
	...
	public PostSearchNodesResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSearchNodesAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSearchNodesAction fill(io.intino.goros.unit.box.actions.PostSearchNodesAction action) {
		action.box = this.box;
