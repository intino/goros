...
public  class ActivityDefinitionBase extends ProcessDefinition {
	...
	public static class ActivityPlacePropertyBase extends PlaceProperty {protected void copy(ActivityPlacePropertyBase instance) {this._code = instance._code;
