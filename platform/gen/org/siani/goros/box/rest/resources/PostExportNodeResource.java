...
public class PostExportNodeResource implements Resource {
	...
	public PostExportNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostExportNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostExportNodeAction fill(org.siani.goros.box.actions.PostExportNodeAction action) {
		action.box = this.box;
