...
public class PostLoadUnassignedTasksToDeleteResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostLoadUnassignedTasksToDeleteResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadUnassignedTasksToDeleteAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadUnassignedTasksToDeleteAction fill(io.intino.goros.unit.box.actions.PostLoadUnassignedTasksToDeleteAction action) {
		action.box = this.box;
