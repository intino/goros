...
public class PostMakeNodePrivateResource implements Resource {
	...
	public PostMakeNodePrivateResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostMakeNodePrivateAction()).execute());
	}

	private org.siani.goros.box.actions.PostMakeNodePrivateAction fill(org.siani.goros.box.actions.PostMakeNodePrivateAction action) {
		action.box = this.box;
