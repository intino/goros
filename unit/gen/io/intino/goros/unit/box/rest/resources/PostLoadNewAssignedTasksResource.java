...
public class PostLoadNewAssignedTasksResource implements Resource {
	...
	public PostLoadNewAssignedTasksResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostLoadNewAssignedTasksAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostLoadNewAssignedTasksAction fill(io.intino.goros.unit.box.actions.PostLoadNewAssignedTasksAction action) {
		action.box = this.box;
