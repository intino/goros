...
public class PostAddDatastoreCubeFactResource implements Resource {
	...
	public PostAddDatastoreCubeFactResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostAddDatastoreCubeFactAction()).execute());
	}

	private org.siani.goros.box.actions.PostAddDatastoreCubeFactAction fill(org.siani.goros.box.actions.PostAddDatastoreCubeFactAction action) {
		action.box = this.box;
