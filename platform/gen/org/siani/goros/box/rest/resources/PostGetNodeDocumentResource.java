...
public class PostGetNodeDocumentResource implements Resource {
	...
	public PostGetNodeDocumentResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unauthorized {
		...
		write(fill(new org.siani.goros.box.actions.PostGetNodeDocumentAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeDocumentAction fill(org.siani.goros.box.actions.PostGetNodeDocumentAction action) {
		action.box = this.box;
