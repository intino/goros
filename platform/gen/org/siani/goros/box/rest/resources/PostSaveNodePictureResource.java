...
public class PostSaveNodePictureResource implements Resource {
	...
	public PostSaveNodePictureResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostSaveNodePictureAction()).execute());
	}

	private org.siani.goros.box.actions.PostSaveNodePictureAction fill(org.siani.goros.box.actions.PostSaveNodePictureAction action) {
		action.box = this.box;
