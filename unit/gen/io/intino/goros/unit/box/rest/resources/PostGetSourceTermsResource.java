...
public class PostGetSourceTermsResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetSourceTermsResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetSourceTermsAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetSourceTermsAction fill(io.intino.goros.unit.box.actions.PostGetSourceTermsAction action) {
		action.box = this.box;
