...
public class PostGetStatusResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetStatusResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetStatusAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetStatusAction fill(io.intino.goros.unit.box.actions.PostGetStatusAction action) {
		action.box = this.box;
