...
public class PostGetNodeReferenceResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeReferenceResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeReferenceAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeReferenceAction fill(io.intino.goros.unit.box.actions.PostGetNodeReferenceAction action) {
		action.box = this.box;
