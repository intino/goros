...
public class PostRecoverNodeResource implements Resource {
	...
	public PostRecoverNodeResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostRecoverNodeAction()).execute());
	}

	private org.siani.goros.box.actions.PostRecoverNodeAction fill(org.siani.goros.box.actions.PostRecoverNodeAction action) {
		action.box = this.box;
