...
public class PostGetTaskProcessResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetTaskProcessResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetTaskProcessAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetTaskProcessAction fill(io.intino.goros.unit.box.actions.PostGetTaskProcessAction action) {
		action.box = this.box;
