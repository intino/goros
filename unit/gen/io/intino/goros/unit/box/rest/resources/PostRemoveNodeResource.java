...
public class PostRemoveNodeResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostRemoveNodeResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostRemoveNodeAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostRemoveNodeAction fill(io.intino.goros.unit.box.actions.PostRemoveNodeAction action) {
		action.box = this.box;
