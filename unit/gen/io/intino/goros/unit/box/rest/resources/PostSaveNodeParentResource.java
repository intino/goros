...
public class PostSaveNodeParentResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostSaveNodeParentResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostSaveNodeParentAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostSaveNodeParentAction fill(io.intino.goros.unit.box.actions.PostSaveNodeParentAction action) {
		action.box = this.box;
