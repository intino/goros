...
public class PostAddNodeFlagResource implements Resource {
	...
	public PostAddNodeFlagResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostAddNodeFlagAction()).execute());
	}

	private org.siani.goros.box.actions.PostAddNodeFlagAction fill(org.siani.goros.box.actions.PostAddNodeFlagAction action) {
		action.box = this.box;
