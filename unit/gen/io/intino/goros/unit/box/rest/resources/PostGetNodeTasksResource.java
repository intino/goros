...
public class PostGetNodeTasksResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostGetNodeTasksResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostGetNodeTasksAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostGetNodeTasksAction fill(io.intino.goros.unit.box.actions.PostGetNodeTasksAction action) {
		action.box = this.box;
