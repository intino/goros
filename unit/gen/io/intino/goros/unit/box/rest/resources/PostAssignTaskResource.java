...
public class PostAssignTaskResource implements Resource {

	private UnitBox box;
	private SparkManager<SparkPushService> manager;

	public PostAssignTaskResource(UnitBox box, SparkManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.intino.goros.unit.box.actions.PostAssignTaskAction()).execute());
	}

	private io.intino.goros.unit.box.actions.PostAssignTaskAction fill(io.intino.goros.unit.box.actions.PostAssignTaskAction action) {
		action.box = this.box;
