...
public class PostGetNodeSchemaResource implements Resource {
	...
	public PostGetNodeSchemaResource(GorosBox box, SparkManager manager) {
		this.box = box;
	...
	public void execute() throws Unknown {
		write(fill(new org.siani.goros.box.actions.PostGetNodeSchemaAction()).execute());
	}

	private org.siani.goros.box.actions.PostGetNodeSchemaAction fill(org.siani.goros.box.actions.PostGetNodeSchemaAction action) {
		action.box = this.box;
